...
## Requirements
- tensorflow 1.8.0 (tensorflow 2.x also OK)
- python 3.7  
- numpy 1.14.2  
- scipy 0.19.0
- moviepy 0.2.3.2
...
## License
Copyright (c) 2020 JungYeonLeeeeeeeee. Contact me for commercial use (or rather any use that is not academic research) (email: snszmsk@gmail.com). Free for research use, as long as proper attribution is given and this copyright notice is retained.
